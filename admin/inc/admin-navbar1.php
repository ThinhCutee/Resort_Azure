...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
    <div class="position-sticky">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link  text-white" aria-current="page" href="./dashboard/index.php">
            ...
            <li class="nav-item">
                ...
                <ul class="nav flex-column ms-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="./dichvu-dat.php">Đặt dịch vụ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="./vemaybay.php">Vé máy bay</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
